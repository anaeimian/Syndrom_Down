...
public class Bazi1Activity6 extends ActionBarActivity {
...
//        setListeners();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Bazi1Activity6.this, BaziListActivity.class);
        tashvigh.release();
        tashvigh = null;
        wordVoice.release();
        wordVoice = null;
                ...
                rotate1.setAnimationListener(new Animation.AnimationListener() {
                    ...
                    public void onAnimationEnd(Animation animation) {
                        ...
                        rotate2.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation animation) {
                                Intent intent = null;
                                intent = new Intent(Bazi1Activity6.this, BaziListActivity.class);
