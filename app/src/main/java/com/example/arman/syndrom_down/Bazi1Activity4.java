...
public class Bazi1Activity4 extends ActionBarActivity {
...
//        setListeners();
    ...
    public void onBackPressed() {
        Intent intent = new Intent(Bazi1Activity4.this, BaziListActivity.class);
    ...
    private void handleIntent() {
        ...
        switch (category) {
            case "khanevade":
                categorySize = 4 - 2 - 2 - 2;
                break;
            case "andam":
                categorySize = 10 - 2 - 2 - 2;
                break;
            case "miveh":
                categorySize = 5 - 2 + 1 - 2 - 2;
                break;
            case "heyvanat":
                categorySize = 6 - 2 - 2 - 2;
                break;
            case "pooshak":
                        ...
                        rotate2.setAnimationListener(new Animation.AnimationListener() {
                            ...
                            public void onAnimationEnd(Animation animation) {
                                ...
                                if (category.equals("pooshak")) {
                                    intent = new Intent(Bazi1Activity4.this, BaziListActivity.class);
                                } else {
                                    intent = new Intent(Bazi1Activity4.this, Bazi1Activity5.class);
                                }
